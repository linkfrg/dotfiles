...
class PowerOffButton(PowermenuButton):
    def __init__(self):
        super().__init__(
            ...
            on_click=lambda *args: Utils.exec_sh_async("poweroff"),
        )
...
class RebootButton(PowermenuButton):
    def __init__(self):
        super().__init__(
            ...
            on_click=lambda *args: Utils.exec_sh_async("reboot"),
        )
...
class HyprlandExitButton(PowermenuButton):
    def __init__(self):
        super().__init__(
            ...
            on_click=lambda *args: Utils.exec_sh_async("hyprctl dispatch exit 0"),
        )
